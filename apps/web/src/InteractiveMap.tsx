...
const layerColors: Record<LayerId, string> = {
  ...
  "mtt-zones": "#6366f1",
  incidents: "#ef4444",
  "bangkok-roads": "#6b7280",
  "bangkok-expressways": "#dc2626",
  "bangkok-canals": "#0ea5e9",
  "bangkok-drainage": "#8b5cf6",
};
  ...
  featureCollections.forEach((collection) => {
    ...
    collection.features.forEach((feature) => {
      ...
      if (feature.geometryType === "Point") {
        ...
        const isDrainageLayer = collection.layerId === "bangkok-drainage";
        const marker = L.circleMarker([lat, lon], {
          ...
          fillOpacity: isDrainageLayer
            ? feature.properties.operationStatus === "active"
              ? 0.8
              : 0.4
            : isNationalFootprint ? 0.5 : isPollutionLayer ? 0.86 : hasRainSignal ? 0.58 : 0.35,
          weight: isDrainageLayer ? 2.5 : 2
        });
      ...
      if (feature.geometryType === "LineString") {
        ...
        const line = L.polyline(latLngs, {
          color: pointColor,
          weight:
            collection.layerId === "bangkok-expressways"
              ? 5.5
              : collection.layerId === "bangkok-roads"
                ? 3
                : collection.layerId === "bangkok-canals"
                  ? 4
